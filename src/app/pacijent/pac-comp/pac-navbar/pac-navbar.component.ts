...
import {ROUTES} from '../pac-sidebar/pac-sidebar.component';

@Component({
  selector: 'app-pac-navbar',
  templateUrl: './pac-navbar.component.html',
  styleUrls: ['./pac-navbar.component.css']
})
export class PacNavbarComponent implements OnInit {
